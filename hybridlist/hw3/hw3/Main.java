			...
			while(exit) {
				...
				switch (number) {
				  case 1:
						...
						System.out.println("bool: "+data.getAdmin(0).getFirstName().equals(firstName));
						System.out.println("soyName:"+data.getAdmin(0).getLastName().equals(lastName));
						System.out.println("password:"+data.getAdmin(0).getPassword().equals(password));
						
						if(data.getAdmin(0).getFirstName().equals(firstName)&& data.getAdmin(0).getLastName().equals(lastName) 
								&& data.getAdmin(0).getPassword().equals(password)) {
				  ...
				  case 3:
						...
						for(int i=0;i<data.custumer.getSize();i++) {
							if(data.custumer.get(i).getFirstName().equals(firstName) && data.custumer.get(i).getLastName().equals(lastName) && data.custumer.get(i).getPassword().equals(password)) {
								CustumerManage panelCustumer =new CustumerManage(data);
								panelCustumer.startShop(data.custumer.get(i));
							}
							else {
								System.out.println("Name or Password Wrong");
							}
